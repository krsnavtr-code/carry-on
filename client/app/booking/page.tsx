          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-50 dark:border-gray-800/80">
              ...
              {currentStep < 4 ? (
                ...
                <button
                  type="submit"
                  className="flex items-center space-x-2 bg-[#5EBC23] hover:bg-[#0C4587] text-white text-xs uppercase tracking-widest font-black px-8 py-3.5 rounded-xl shadow-md transition-all duration-300"
                >
                  <Send className="w-4 h-4" /> <span>Confirm Allocation</span>
                </button>
              )}
            </div>
          </form>
