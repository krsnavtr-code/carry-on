      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          {dailyFeatures.map((feat, idx) => (
            <div
              key={idx}
              className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-900 rounded-2xl p-6 lg:p-8 shadow-sm flex flex-col space-y-4 hover:shadow-md transition-shadow"
            >
